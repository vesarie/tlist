...
Kenttä password sisältää merkkijonon, joka voidaan välittää salasanoja käsittelevälle metodille sellaisenaan. Merkkijonon sisältö riippuu käytettävästä salausmoduulista, mutta se sisältää salasanan tiivisteen, tiivisteen laskennassa käytetyn suolan ja muita toteutuksen tallentamia tietoja.

\renewcommand{\arraystretch}{1.2}
\makebox[\textwidth][c]{
\begin{tabularx}{1.15\textwidth}{lllX}
\toprule
Käsite & Attribuutti & Arvojoukko & Kuvailu \\
\midrule
User &
forename    & Merkkijono (max 50)  & Käyttäjän etunimi      \\ 
& surname     & Merkkijono (max 50)  & Käyttäjän sukunimi    \\ 
